...
SELECT public.create_hypertable('crypto_scout.bybit_linear_kline_1d', 'start_time', chunk_time_interval => INTERVAL '1 month', if_not_exists => TRUE);
...
SELECT public.create_hypertable('crypto_scout.bybit_linear_public_trade', 'trade_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE);
...
SELECT public.create_hypertable('crypto_scout.bybit_linear_order_book_1', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE);
...
SELECT public.create_hypertable('crypto_scout.bybit_linear_order_book_50', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE);
...
SELECT public.create_hypertable('crypto_scout.bybit_linear_order_book_200', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE);
...
SELECT public.create_hypertable('crypto_scout.bybit_linear_order_book_1000', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE);
...
SELECT public.create_hypertable('crypto_scout.bybit_linear_all_liquidation', 'event_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE);
