...
select public.create_hypertable('crypto_scout.bybit_ta_linear_public_trade', 'trade_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
...
select public.create_hypertable('crypto_scout.bybit_ta_linear_order_book_1', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
...
select public.create_hypertable('crypto_scout.bybit_ta_linear_order_book_50', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
...
select public.create_hypertable('crypto_scout.bybit_ta_linear_order_book_200', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
...
select public.create_hypertable('crypto_scout.bybit_ta_linear_order_book_1000', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
...
select public.create_hypertable('crypto_scout.bybit_ta_linear_all_liquidation', 'event_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
