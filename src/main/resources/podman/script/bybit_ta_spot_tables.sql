...
select add_reorder_policy('crypto_scout.bybit_ta_spot_order_book_50', 'idx_bybit_ta_spot_order_book_50_symbol_side_engine_time');
select add_reorder_policy('crypto_scout.bybit_ta_spot_order_book_200', 'idx_bybit_ta_spot_order_book_200_symbol_side_engine_time');
select add_reorder_policy('crypto_scout.bybit_ta_spot_order_book_1000', 'idx_bybit_ta_spot_order_book_1000_symbol_side_engine_time');
