...
create TABLE IF NOT EXISTS crypto_scout.bybit_ta_spot_public_trade (
    ...
    CONSTRAINT bybit_ta_spot_public_trade_pkey PRIMARY KEY (symbol, trade_time, price, size, taker_side)
);
...
create TABLE IF NOT EXISTS crypto_scout.bybit_ta_spot_order_book_1 (
    ...
    price DOUBLE PRECISION NOT NULL,
    size DOUBLE PRECISION NOT NULL,
    CONSTRAINT bybit_ta_spot_order_book_1_pkey PRIMARY KEY (symbol, engine_time, side, price)
);
...
select public.create_hypertable('crypto_scout.bybit_ta_spot_order_book_1', 'engine_time', chunk_time_interval => INTERVAL '12 hours', if_not_exists => TRUE);
...
create TABLE IF NOT EXISTS crypto_scout.bybit_ta_spot_order_book_50 (
    ...
    price DOUBLE PRECISION NOT NULL,
    size DOUBLE PRECISION NOT NULL,
    CONSTRAINT bybit_ta_spot_order_book_50_pkey PRIMARY KEY (symbol, engine_time, side, price)
);
...
select public.create_hypertable('crypto_scout.bybit_ta_spot_order_book_50', 'engine_time', chunk_time_interval => INTERVAL '12 hours', if_not_exists => TRUE);
...
create TABLE IF NOT EXISTS crypto_scout.bybit_ta_spot_order_book_200 (
    ...
    price DOUBLE PRECISION NOT NULL,
    size DOUBLE PRECISION NOT NULL,
    CONSTRAINT bybit_ta_spot_order_book_200_pkey PRIMARY KEY (symbol, engine_time, side, price)
);
...
select public.create_hypertable('crypto_scout.bybit_ta_spot_order_book_200', 'engine_time', chunk_time_interval => INTERVAL '12 hours', if_not_exists => TRUE);
...
create TABLE IF NOT EXISTS crypto_scout.bybit_ta_spot_order_book_1000 (
    ...
    price DOUBLE PRECISION NOT NULL,
    size DOUBLE PRECISION NOT NULL,
    CONSTRAINT bybit_ta_spot_order_book_1000_pkey PRIMARY KEY (symbol, engine_time, side, price)
);
...
select public.create_hypertable('crypto_scout.bybit_ta_spot_order_book_1000', 'engine_time', chunk_time_interval => INTERVAL '12 hours', if_not_exists => TRUE);
...
select add_reorder_policy('crypto_scout.bybit_ta_spot_order_book_50', 'idx_bybit_ta_spot_order_book_50_engine_time');
select add_reorder_policy('crypto_scout.bybit_ta_spot_order_book_200', 'idx_bybit_ta_spot_order_book_200_engine_time');
