-- Bybit Ta Spot tables and policies (TimescaleDB PG17)

-- =========================
-- TA PUBLIC TRADES (normalized: 1 row per trade)
-- =========================

create TABLE IF NOT EXISTS crypto_scout.bybit_ta_spot_public_trade (
    id BIGSERIAL,
...
select public.create_hypertable('crypto_scout.bybit_ta_spot_public_trade', 'trade_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
...
select public.add_compression_policy('crypto_scout.bybit_ta_spot_public_trade', interval '14 days');
select public.add_reorder_policy('crypto_scout.bybit_ta_spot_public_trade', 'idx_bybit_ta_spot_public_trade_symbol_time');
select public.add_retention_policy('crypto_scout.bybit_ta_spot_public_trade', interval '365 days');
...
create TABLE IF NOT EXISTS crypto_scout.bybit_ta_spot_order_book_1 (
    id BIGSERIAL,
    symbol TEXT NOT NULL,
...
select public.create_hypertable('crypto_scout.bybit_ta_spot_order_book_1', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
...
select public.create_hypertable('crypto_scout.bybit_ta_spot_order_book_50', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
...
select public.create_hypertable('crypto_scout.bybit_ta_spot_order_book_200', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
...
select public.create_hypertable('crypto_scout.bybit_ta_spot_order_book_1000', 'engine_time', chunk_time_interval => INTERVAL '6 hours', if_not_exists => TRUE, partitioning_column => 'symbol', number_partitions => 16);
...
alter table crypto_scout.bybit_ta_spot_order_book_50 set (
    timescaledb.compress,
    timescaledb.compress_segmentby = 'symbol, side',
    timescaledb.compress_orderby = 'engine_time DESC, price DESC, id DESC'
);
alter table crypto_scout.bybit_ta_spot_order_book_200 set (
    timescaledb.compress,
    timescaledb.compress_segmentby = 'symbol, side',
    timescaledb.compress_orderby = 'engine_time DESC, price DESC, id DESC'
);
alter table crypto_scout.bybit_ta_spot_order_book_1000 set (
    timescaledb.compress,
    timescaledb.compress_segmentby = 'symbol, side',
    timescaledb.compress_orderby = 'engine_time DESC, price DESC, id DESC'
);
...
select public.add_compression_policy('crypto_scout.bybit_ta_spot_order_book_1', interval '14 days');
select public.add_compression_policy('crypto_scout.bybit_ta_spot_order_book_50', interval '14 days');
select public.add_compression_policy('crypto_scout.bybit_ta_spot_order_book_200', interval '14 days');
select public.add_compression_policy('crypto_scout.bybit_ta_spot_order_book_1000', interval '14 days');

-- Reorder policies for order book tables
select public.add_reorder_policy('crypto_scout.bybit_ta_spot_order_book_1', 'idx_bybit_ta_spot_order_book_1_symbol_side_engine_time');
select public.add_reorder_policy('crypto_scout.bybit_ta_spot_order_book_50', 'idx_bybit_ta_spot_order_book_50_symbol_side_engine_time');
select public.add_reorder_policy('crypto_scout.bybit_ta_spot_order_book_200', 'idx_bybit_ta_spot_order_book_200_symbol_side_engine_time');
select public.add_reorder_policy('crypto_scout.bybit_ta_spot_order_book_1000', 'idx_bybit_ta_spot_order_book_1000_symbol_side_engine_time');

-- Retention policies for order book tables
select public.add_retention_policy('crypto_scout.bybit_ta_spot_order_book_1', interval '365 days');
select public.add_retention_policy('crypto_scout.bybit_ta_spot_order_book_50', interval '365 days');
select public.add_retention_policy('crypto_scout.bybit_ta_spot_order_book_200', interval '365 days');
select public.add_retention_policy('crypto_scout.bybit_ta_spot_order_book_1000', interval '365 days');
